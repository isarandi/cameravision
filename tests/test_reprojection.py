...
class TestPointReprojection:
    ...
    def test_identity_reprojection(self, simple_camera):
        ...
        reprojected = cameravision.reprojection.reproject_image_points(
    ...
    def test_only_intrinsics_change(self):
        ...
        camera1 = cameravision.Camera(
            intrinsic_matrix=[[500, 0, 320], [0, 500, 240], [0, 0, 1]],
        )
        camera2 = cameravision.Camera(
            intrinsic_matrix=[[600, 0, 400], [0, 600, 300], [0, 0, 1]],
        )

        # Principal point
        pp1 = np.array([[320, 240]], np.float32)
        reprojected = cameravision.reprojection.reproject_image_points(pp1, camera1, camera2)
    ...
    def test_rotation_moves_points(self):
        ...
        reprojected = cameravision.reprojection.reproject_image_points(point, camera1, camera2)
    ...
    def test_reprojection_roundtrip(self):
        ...
        intermediate = cameravision.reprojection.reproject_image_points(points, camera1, camera2)
        recovered = cameravision.reprojection.reproject_image_points(intermediate, camera2, camera1)
...
class TestImageReprojection:
    ...
    def test_identity_reprojection(self, simple_camera):
        ...
        reprojected = cameravision.reprojection.reproject_image(
...
class TestReprojectionWithDistortion:
    ...
    def test_undistort_to_pinhole(self):
        ...
        distorted = cameravision.Camera(
            intrinsic_matrix=[[500, 0, 320], [0, 500, 240], [0, 0, 1]],
            distortion_coeffs=[-0.2, 0.1, 0, 0, 0],
        )
        pinhole = cameravision.Camera(
            intrinsic_matrix=[[500, 0, 320], [0, 500, 240], [0, 0, 1]],
        )

        # Center point should be unchanged
        center = np.array([[320, 240]], np.float32)
        reprojected = cameravision.reprojection.reproject_image_points(center, distorted, pinhole)
    ...
    def test_distort_from_pinhole(self):
        ...
        # Center point should be unchanged
        center = np.array([[320, 240]], np.float32)
        reprojected = cameravision.reprojection.reproject_image_points(center, pinhole, distorted)
...
class TestReprojectionEdgeCases:
    ...
    def test_empty_points(self, simple_camera):
        ...
        result = cameravision.reprojection.reproject_image_points(
